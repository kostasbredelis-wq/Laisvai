        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_JobListings_ClientProfiles_ClientId",
                        column: x => x.ClientId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Services_FreelancerProfiles_FreelancerId",
                        column: x => x.FreelancerId,
                        principalTable: "FreelancerProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Applications_FreelancerProfiles_FreelancerId",
                        column: x => x.FreelancerId,
                        principalTable: "FreelancerProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Conversations_JobListings_JobListingId",
                        column: x => x.JobListingId,
                        principalTable: "JobListings",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Applications_JobListingId_FreelancerId",
                table: "Applications",
                columns: new[] { "JobListingId", "FreelancerId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Conversations_FreelancerId_ClientId",
                table: "Conversations",
                columns: new[] { "FreelancerId", "ClientId" },
                unique: true,
                filter: "\"JobListingId\" IS NULL");

            migrationBuilder.CreateIndex(
                name: "IX_Conversations_FreelancerId_ClientId_JobListingId",
                table: "Conversations",
                columns: new[] { "FreelancerId", "ClientId", "JobListingId" },
                unique: true,
                filter: "\"JobListingId\" IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_Conversations_JobListingId",
                table: "Conversations",
                column: "JobListingId");
